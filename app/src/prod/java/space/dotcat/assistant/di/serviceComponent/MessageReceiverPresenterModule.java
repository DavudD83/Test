...
public class MessageReceiverPresenterModule {
    ...
    private MessageReceiverServiceContract mServiceContract;

    public MessageReceiverPresenterModule(MessageReceiverServiceContract serviceContract) {
    ...
    MessageReceiverPresenter provideMessageReceiverPresenter(LiveData<Boolean> wifiListener, WebSocketService webSocketService,
        ...
        return new MessageReceiverPresenter(mServiceContract, wifiListener, webSocketService, authRepository, roomRepository,
